...
public class ReadAndWriteExcelContentDemo1 
{
	...
	private static void readWriteContent()
	{
		...
		try
		{
			fin=new FileInputStream("G:\\PoiApiExcercise\\Demo\\Testdemo.xlsx");
			...
			for(int r=0;r<rc;r++)
			{
				...
				fout=new FileOutputStream("G:\\PoiApiExcercise\\Demo\\Testdemo.xlsx");
				wb.write(fout);
			}
		}
		catch(Exception e)
